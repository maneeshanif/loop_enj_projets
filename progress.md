...
## Not Started ⏳
- Project 4: Fix Loop with Real Checker (Concepts 8, 9, 11)
- Project 5: Codify the Body (Dynamic workflows, Concepts 8, 11)
- Project 6: The Doorbell Loop (Concepts 7, 10)
- Project 7: Break It on Purpose (Observability, Concepts 13, 14)
- Project 8: Your Own Daily Loop — Capstone (all six parts)
- Project 9: Rehearse a Routine for Free (Appendix A1, A3, A5)
- Project 10: The Secrets Drill (Appendix A4, A2)
- Project 11: Build the Two-Routine Gate (Appendix A3, A4, A6)
